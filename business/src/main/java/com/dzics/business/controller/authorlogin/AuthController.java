package com.dzics.business.controller.authorlogin;

import com.dzics.business.common.annotation.OperLog;
import com.dzics.business.framework.auth.JwtAuthService;
...
import com.dzics.business.model.vo.user.SwitchSite;
...
public class AuthController {
    ...
    @OperLog(operModul = "账号授权", operType = OperType.OTHER, operDesc = "登录")
