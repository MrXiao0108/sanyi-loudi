...
import com.dzics.business.model.vo.rolemenu.AddRole;
import com.dzics.business.model.vo.rolemenu.DisableEnabledRole;
import com.dzics.business.model.vo.rolemenu.SelRole;
import com.dzics.business.model.vo.rolemenu.UpdateRole;
...
//    @OperLog(operModul = "角色管理", operType = OperType.QUERY, operDesc = "角色列表", operatorType = "后台")
    ...
    public Result<ResSysRole> getRoles(PageLimit pageLimit, SelRole selRole,
...
//    @OperLog(operModul = "角色管理", operType = OperType.QUERY, operDesc = "角色详情", operatorType = "后台")
    ...
    public Result delRole(
            ...
            @RequestHeader(value = "jwt_token", required = false) @ApiParam(value = "token令牌", required = true) String tokenHdaer,
            @RequestHeader(value = "sub", required = false) @ApiParam(value = "用户账号", required = true) String sub) {
        return businessUserService.delRole(Long.valueOf(roleId), sub);
    }
