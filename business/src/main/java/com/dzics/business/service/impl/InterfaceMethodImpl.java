...
import com.dzics.common.model.entity.SysInterfaceGroupConfiguration;
import com.dzics.common.model.entity.SysInterfaceMethod;
import com.dzics.common.model.request.kb.*;
import com.dzics.common.model.response.Result;
import com.dzics.common.service.SysInterfaceGroupConfigurationService;
import com.dzics.common.service.SysInterfaceGroupService;
import com.dzics.common.service.SysInterfaceMethodService;
...
public class InterfaceMethodImpl implements InterfaceMethod {
    ...
    public Result getGroup(String sub, PageLimit pageLimit) {
        PageHelper.startPage(pageLimit.getPage(), pageLimit.getLimit());
        List<SysInterfaceGroup> list = interfaceGroupService.list();
    ...
    public Result addGroupInerfaceConfig(String sub, AddInterfaceGroupConfiguration groupConfiguration) {
        ...
        List<SysInterfaceGroupConfiguration> collect = groupConfiguration.getInterfaceIds().stream().map(inface -> new SysInterfaceGroupConfiguration(groupId, inface.getInterfaceId(), inface.getCacheDuration())).collect(Collectors.toList());
...
//        已选中接口信息
    ...
    @Override
    public List<SysInterfaceMethod> getMethodGroup(String methodGroup) {
        QueryWrapper<SysInterfaceGroup> wp = new QueryWrapper<>();
