...
import com.dzics.kanban.enums.MenuType;
...
import com.dzics.kanban.service.KanbanService;
import com.dzics.kanban.service.SysKanbanRoutingService;
import com.dzics.kanban.service.SysUserServiceDao;
import com.dzics.kanban.util.ChildrenUtils;
import com.dzics.kanban.util.StringToUpcase;
...
public class KanbanServiceImpl implements KanbanService {
    ...
    public Result<MenusInfo> selMenuPermission(String sub) {
        ...
        List<SysKanbanRouting> list = kanbanRoutingService.list(wp);
    ...
    public Result addPermission(AddPermission addPermission, String sub) {
        ...
        if (addPermission.getParentId().longValue() != 0) {
            SysKanbanRouting byId = kanbanRoutingService.getById(addPermission.getParentId());
...
//        删除子节点
    ...
    @Override
    public Result<SysKanbanRouting> selRoutingDetailsOrder(SelKbRouting kbRouting, String sub) {
        QueryWrapper<SysKanbanRouting> wp = new QueryWrapper<>();
