...
import com.dzics.kanban.dao.SysUserRoleMapper;
...
public class SysUserRoleServiceImpl extends ServiceImpl<SysUserRoleMapper, SysUserRole> implements SysUserRoleService {
    ...
    @Override
    public List<Long> listRoleId(Long id, String useOrgCode, Integer code) {
    ...
    public String getSystemRunConfig() {
        String runconfig  = sysRoleMapper.getSystemRunConfig();
        return runconfig;
    }
